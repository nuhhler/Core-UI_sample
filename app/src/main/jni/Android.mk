...
LOCAL_SRC_FILES := com_gab_test_core_ui_sample_PressMe.cpp com_gab_test_core_ui_sample_Core.cpp AndroidGabCoreWrapper.cpp Core/GabCore.cpp Core/GabAsyncResponse.cpp Core/GabContact.cpp AndroidGui.cpp
